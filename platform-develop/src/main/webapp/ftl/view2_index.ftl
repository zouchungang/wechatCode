            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <div class="file-manager">
                        ...
                        <ul class="category-list"  id="leftOneMenu">
                        </ul>
                        <div class="hr-line-dashed"></div>
                    </div>
                </div>
            ...
            <#if entity.hiddenWhether == "false">
                <#if entity.formType == "text"||entity.formType == "number">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">${entity.fieldNameU}
                            ...
                            :</label>
                        <div class="col-sm-6">
                            <input type="text" id="${entity.fieldName}" name="${entity.fieldName}" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <div class="radio radio-info radio-inline">
                                <input type="radio" id="${entity.fieldName}1" value="true" name="${entity.fieldName}"
                                       checked="checked">
                ...
                <#if entity.formType == "date">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" id="${entity.fieldName}" name="${entity.fieldName}"
                ...
                <#if entity.formType == "textarea">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <textarea type="text" id="${entity.fieldName}" name="${entity.fieldName}"
                                      class="form-control" placeholder="${entity.fieldNameU}"></textarea>
                        </div>
                    </div>
                </#if>
            </#if>
...
<script type="text/javascript"
        src="<#noparse>${ctx }</#noparse>/common/h5/js/plugins/layer/laydate/laydate.js"></script>
</#if>
<#if haveWaijian==true>
...
<#if havaTree == true>
    ...
    function loadOneMenu(){
        alert("请修改树结构数据源" +${entity.fieldName});
        $.ajax({
            type: "GET",
            url: "<#noparse>${ctx }</#noparse>/list",
            dataType:"json",
            data: {
            },
    ...
    function loadData() {
        ...
        <#if sortFlag==true>
            ...
            queryParams: function (params) {
                var par = {<#list searchList as entity><#if entity.formType == "wjselect">"${entity.fieldName}.id": $("#search${entity.fieldName}"<#if havaTree == true>"${treeTE.fieldName}.id":${treeTE.fieldName}</#if>).val(),
                    <#else>"${entity.fieldName}": $("#search${entity.fieldName}").val(),</#if></#list>};
            ...
            <#if entity.mustWrite == "true"||entity.validateType!="0">
                <#if entity.mustWrite == "true"&&entity.validateType=="0">
                    <#if entity.formType == "wjselect">
                        '${entity.fieldName}.id'
                    :
                        "请选择${entity.fieldNameU}",
                    </#if>
                    <#if entity.formType != "wjselect">
                    ${entity.fieldName}:
                        "请输入${entity.fieldNameU}",
                    </#if>
                <#elseif entity.mustWrite == "true"&&entity.validateType!="0">
                ${entity.fieldName}:
                    {
