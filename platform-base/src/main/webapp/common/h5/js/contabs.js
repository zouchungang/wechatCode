$(function () {
    ...
    function c() {
        ...
        if (k) {
            var p = '<a href="javascript:;" class="active J_menuTab" data-id="' + o + '">' + l + ' <i title="刷新" class="fa fa-refresh"></i> <i title="关闭" class="fa fa-times-circle"></i></a>';
    ...
    $(".J_menuTabs").on("click", ".J_menuTab .fa-times-circle", h);
    ...
    $(".J_menuTabs").on("click", ".J_menuTab .fa-refresh", rf);
