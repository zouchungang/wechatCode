...
<script type="text/javascript">
    ...
    function loadData() {
        var url = "${ctx }/bussiness/rUsersinfoEntity/page";
        $('#tablepager').bootstrapTable({
            ...
            queryParams:function(params){
                var par={"uid":$("#searchuid").val(),"truename":$("#searchtruename").val(),"sex":$("#searchsex").val(),"address":$("#searchaddress").val(),"image":$("#searchimage").val(),"remark":$("#searchremark").val(),};
    ...
    function add() {
        ...
        dilogForm("添加", "${ctx }/bussiness/rUsersinfoEntity");
    }
    function editor() {
        $('#myForm')[0].reset();
        $("#myForm").validate().resetForm();
        ...
        if (row != null) {
            dilogForm("修改", "${ctx }/bussiness/rUsersinfoEntity/" + row.id);
            $("#_method").val("put");
            $("#id").val(row.id);
        ...
        if (row != null) {
            layer.confirm("确认删除？", {
                ...
                $.ajax({
                    type: "post",
                    dataType: "json",
                    url: "${ctx }/bussiness/rUsersinfoEntity/" + row.id,
                    data: {_method: "delete"},
