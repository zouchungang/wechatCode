                    ...
                    <form class="form-horizontal" id="employeeForm">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <p class="form-control-static">&nbsp;&nbsp;${companyEmployee.employeeCode}</p>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <p class="form-control-static">&nbsp;&nbsp;${companyEmployee.employeeName}</p>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="radio radio-info radio-inline">
                                        <input type="radio" id="sex1" value="1" name="sex"
                                               <c:if test="${companyEmployee.sex eq 1}">checked="checked"</c:if>>
                                        <label for="sex1">男</label>
                                    </div>
                                    <div class="radio radio-info radio-inline">
                                        <input type="radio" id="sex2" value="0" name="sex"
                                               <c:if test="${companyEmployee.sex ne 1}">checked="checked"</c:if>>
...
<script>
    ...
    var picNum = 1;
    var rootPath = '${ctx}';
    var viewPath = '${staticUpfileCtx }';
    $(function () {
        validateForm();
        initWebuploader("${ctx}/company/employee/photo", picNum, picAllSize, picSingleSize, rootPath, viewPath);
        var imgFile = '${companyEmployee.photo}';
    ...
    function submitForm() {
        ...
        if (v.form()) {
            ...
            $.ajax({
                type: "POST",
                url: "${ctx}/company/employee/alterInfo",
                data: $('#employeeForm').serialize(),
                dataType: "json",
                success: function (msg) {
                    if (isLogin(msg)) {
                        layer.close(noticeIndex);//关闭加载动画
                        layer.confirm(msg + "---点击确定刷新页面", {
                                    btn: ['确定']
