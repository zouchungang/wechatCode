                            ...
                            <div class="row form-horizontal">
                                <div class="col-sm-9">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <input type="text" id="searchOrderTime" placeholder="起始年份"
                                                   class="form-control layer-date"
                                                   onclick="laydate({istime: true, format: 'YYYY'})">
                                            <input type="text" id="searchOrderTimeEnd" placeholder="截止年份"
                                                   class="form-control layer-date"
                                                   onclick="laydate({istime: true, format: 'YYYY'})">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="col-sm-2 control-label">子单号</label>
                                        <div class="col-sm-2">
...
<script type="text/javascript">
    ...
    function changeURL() {
        ...
        a.setAttribute("href", "${ctx}/company/report/yearTicketToExcel" + str)
    }

    function loadData() {
        var url = "${ctx }/company/report/loadYearSales";
