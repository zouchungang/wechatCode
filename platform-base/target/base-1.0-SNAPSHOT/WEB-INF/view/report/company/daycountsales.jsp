                            ...
                            <div class="row form-horizontal">
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" id="searchOrderTime" placeholder="起始日期"
                                                   class="form-control layer-date"
                                                   onclick="laydate({istime: true, format: 'YYYY-MM-DD'})">
                                            <input type="text" id="searchOrderTimeEnd" placeholder="截止日期"
                                                   class="form-control layer-date"
                                                   onclick="laydate({istime: true, format: 'YYYY-MM-DD'})">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <select type="text" id="searchOrderStatus" class="form-control">
...
<script type="text/javascript">
    ...
    function changeURL() {
        ...
        a.setAttribute("href", "${ctx}/company/report/dayTicketToExcel" + str)
    }


    function loadData() {
        var url = "${ctx }/company/report/loadDaySales";
