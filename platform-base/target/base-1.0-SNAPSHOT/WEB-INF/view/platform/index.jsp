...
<div class="signinpanel">
    <div class="row">
        <div class="col-sm-7">
            <div class="signin-info">
                ...
                <div class="m-b"></div>
                <h4>欢迎使用 <strong>智慧旅游云平台</strong></h4>
                <ul class="m-b">
        ...
        <div class="col-sm-5">
            <form method="post" id="login_form" action="${ctx }/platform/login">
                <h4 class="no-margins">登录：</h4>
                <p class="m-t-md">登录到旅游智慧后台</p>
                ...
                <span style="color: #bd362f">${msg}</span>
    ...
    <div class="signup-footer">
        <div class="pull-left">
            &copy; 2017 All Rights Reserved. <a href="http://www.unionticket.cn/" target="_blank">租房网</a>
        </div>
    </div>
</div>
